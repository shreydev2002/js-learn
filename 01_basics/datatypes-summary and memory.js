...
// Heap memory used by Reference(Non-primitive) datatypes


// In stack memory work is done on the copy of a variable's value
// But In Heap memory work is done the reference of the variable